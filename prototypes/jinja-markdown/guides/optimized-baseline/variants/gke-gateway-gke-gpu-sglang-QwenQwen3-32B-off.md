<!-- GENERATED FILE — DO NOT EDIT. Variant: infra_provider=gke router_mode=gateway gateway_provider=gke accelerator=gpu model_server=sglang model=Qwen/Qwen3-32B monitoring=off. Regenerate with: guidegen.py render-md <guide dir> -->
> **Configuration:** infra_provider=gke router_mode=gateway gateway_provider=gke accelerator=gpu model_server=sglang model=Qwen/Qwen3-32B monitoring=off — [all configurations](../readonly-guide.md)
