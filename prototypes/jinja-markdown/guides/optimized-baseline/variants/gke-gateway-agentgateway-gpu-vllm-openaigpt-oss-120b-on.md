<!-- GENERATED FILE — DO NOT EDIT. Variant: infra_provider=gke router_mode=gateway gateway_provider=agentgateway accelerator=gpu model_server=vllm model=openai/gpt-oss-120b monitoring=on. Regenerate with: guidegen.py render-md <guide dir> -->
> **Configuration:** infra_provider=gke router_mode=gateway gateway_provider=agentgateway accelerator=gpu model_server=vllm model=openai/gpt-oss-120b monitoring=on — [all configurations](../readonly-guide.md)
