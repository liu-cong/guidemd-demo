...
<VariantSwitcher current={{"infra_provider": "base", "router_mode": "gateway", "gateway_provider": "istio", "accelerator": "cpu", "model_server": "vllm", "model": "Qwen/Qwen3-32B", "monitoring": "on"}} />
