...
<VariantSwitcher current={{"infra_provider": "gke", "router_mode": "gateway", "gateway_provider": "gke", "accelerator": "gpu", "model_server": "vllm", "model": "Qwen/Qwen3-32B", "monitoring": "off"}} />
