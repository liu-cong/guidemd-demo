...
<VariantSwitcher current={{"infra_provider": "base", "router_mode": "standalone", "gateway_provider": "none", "accelerator": "gpu", "model_server": "sglang", "model": "Qwen/Qwen3-32B", "monitoring": "off"}} />
