...
<VariantSwitcher current={{"infra_provider": "base", "router_mode": "gateway", "gateway_provider": "agentgateway", "accelerator": "gpu", "model_server": "vllm", "model": "openai/gpt-oss-120b", "monitoring": "off"}} />
