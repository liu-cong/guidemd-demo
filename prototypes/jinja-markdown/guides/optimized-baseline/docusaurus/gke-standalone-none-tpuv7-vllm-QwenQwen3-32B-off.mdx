...
<VariantSwitcher current={{"infra_provider": "gke", "router_mode": "standalone", "gateway_provider": "none", "accelerator": "tpu/v7", "model_server": "vllm", "model": "Qwen/Qwen3-32B", "monitoring": "off"}} />
