...
<VariantSwitcher current={{"infra_provider": "gke", "router_mode": "standalone", "gateway_provider": "none", "accelerator": "gpu", "model_server": "vllm", "model": "openai/gpt-oss-120b", "monitoring": "off"}} />
