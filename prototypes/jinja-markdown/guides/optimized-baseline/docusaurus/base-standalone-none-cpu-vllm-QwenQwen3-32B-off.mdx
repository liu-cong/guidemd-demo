...
<VariantSwitcher current={{"infra_provider": "base", "router_mode": "standalone", "gateway_provider": "none", "accelerator": "cpu", "model_server": "vllm", "model": "Qwen/Qwen3-32B", "monitoring": "off"}} />
