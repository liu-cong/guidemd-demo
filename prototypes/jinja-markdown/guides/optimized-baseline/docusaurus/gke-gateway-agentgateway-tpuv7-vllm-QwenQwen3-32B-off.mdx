...
<VariantSwitcher current={{"infra_provider": "gke", "router_mode": "gateway", "gateway_provider": "agentgateway", "accelerator": "tpu/v7", "model_server": "vllm", "model": "Qwen/Qwen3-32B", "monitoring": "off"}} />
