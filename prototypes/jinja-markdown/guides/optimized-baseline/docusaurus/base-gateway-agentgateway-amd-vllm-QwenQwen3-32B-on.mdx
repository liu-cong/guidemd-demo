...
<VariantSwitcher current={{"infra_provider": "base", "router_mode": "gateway", "gateway_provider": "agentgateway", "accelerator": "amd", "model_server": "vllm", "model": "Qwen/Qwen3-32B", "monitoring": "on"}} />
